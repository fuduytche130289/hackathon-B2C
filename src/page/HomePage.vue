<template>
  <div>
    ...
    <div class="container mx-auto">
      <h4 class="text-2xl font-bold mt-5 mx-8">Sản phẩm mới nhất</h4>
      <div class="grid  grid-cols-1 md:grid-rows-2 md:grid-cols-4 mt-5 gap-10 mx-8">
        ...
        <div class="bg-white shadow-lg col-span-1"
          ...
          <div>
            <router-link @click.native="scrollToTop" :to="{name:'detail-product',query:{id:cartsItem.id}} ">
              <img :src="cartsItem.image" class="z-10 w-full h-72 object-cover" alt="shoe">
            ...
            <div class="space-y-4 mt-5 px-4 ">
              ...
              <p class="font-bold text-2xl text-red-500 text-left"><span>${{ cartsItem.price }}.00 </span></p>
            </div>
            </router-link>
            <div class="flex w-full mt-5 items-center justify-between pl-2">
              ...
              <div class="gap-1 flex mr-2 mb-2">
  ...
  methods: {
    async getData() {
      try {
        ...
        this.homeData = resp.data.data.content;
